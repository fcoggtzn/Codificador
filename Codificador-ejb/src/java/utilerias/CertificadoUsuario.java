...
public class CertificadoUsuario implements Serializable {
    ...
    public CertificadoUsuario(String rfc) {
        try {
            ...
            InputStream keyResource = new FileInputStream(new File(ruta + "/empresas/" + rfc + "/" + rfc + ".key"));
            ...
            keyResource = new FileInputStream(new File(ruta + "/empresas/" + rfc + "/" + rfc + ".cer"));
    ...
    private String getClave(String rfc) {
        ...
        File file = new File(ruta + "/empresas/" + rfc + "/clave.txt");
    ...
    public static byte[] getXSL(String rfc,String tipo) {
        ...
        try {
            ...
            BufferedInputStream bis;
                  ...
                  //   InputStream keyResource = CertificadoUsuario.class.getResourceAsStream("../resources/" + rfc + "/impresionCFDI_"+tipo+".xsl");
            InputStream keyResource =  new FileInputStream(new File(ruta + "/empresas/" + rfc + "/impresionCFDI_"+tipo+".xsl"));
