 ...
 */
@Entity
@Table(name = "codigo_postal", catalog = "catalogoSat", schema = "")
@XmlRootElement
@NamedQueries({
    ...
    , @NamedQuery(name = "CodigoPostal.findByCodigoPostal", query = "SELECT c FROM CodigoPostal c WHERE c.codigoPostal = :codigoPostal")
...
public class CodigoPostal implements Serializable {
    ...
    public String toString() {
        return "catalogo.entidad.CodigoPostal[ id=" + id + " ]";
    }
